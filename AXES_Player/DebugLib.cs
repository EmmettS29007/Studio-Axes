...
namespace AXES_Player
{
    public static class DebugLib
    {
        ...
        )
        {
            ...
            for (int i = 0; i < divisions; i++)
            {
                sb.DrawLineCentered(centerPoint, edgePos, thickness, color);
        ...
        {
            sb.DrawLineCentered(point1, point2, thickness, color);
            sb.DrawLineCentered(point2, point3, thickness, color);
            sb.DrawLineCentered(point3, point1, thickness, color);
        }
